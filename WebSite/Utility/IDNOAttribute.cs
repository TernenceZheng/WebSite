...
{
    public sealed class IDNOAttribute : ValidationAttribute, IClientValidatable
    {

        public const string RegExString = @"^[A-Z]{1}[0-9]{9}$";

        public IDNOAttribute()
        {
        ...
        public override bool IsValid(object value)
        {
            ...
            if (value is string)
            {
                ErrorMessage = FormatErrorMessage("身份證字號");
                return Check(value.ToString().ToUpper());
            }
        ...
        {
            return this.ErrorMessage ??  ErrorMessageResource._10000033;
        }
    }
}